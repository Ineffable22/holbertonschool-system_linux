...
{
	printf("%d\n", strncasecmp(S1, S1, 1));
	printf("%d\n", asm_strncasecmp(S1, S1, 1));

	printf("%d\n", strncasecmp(S1, S2, 11));
	printf("%d\n", asm_strncasecmp(S1, S2, 11));

	printf("%d\n", strncasecmp(S1, S3, 11));
	printf("%d\n", asm_strncasecmp(S1, S3, 11));

	printf("%d\n", strncasecmp(S1, S4, 11));
	printf("%d\n", asm_strncasecmp(S1, S4, 11));
